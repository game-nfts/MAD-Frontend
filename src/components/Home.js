        ...
        <div className="w-full flex-grow max-w-7xl mx-auto flex relative text-white">
          <div className="flex flex-col w-full mx-4 sm:mx-6 lg:mx-8">
            ...
            <div className="flex flex-row">
              <div className="mr-4">
                <SlantButton onMouseEnter={() => handleHover('auction')} onMouseLeave={() => handleHover('')} onClick={() => {}} text="Auction" className="bg-gray-500 hover:bg-green-50h hover:border-gray-70" />
              </div>
              <div className="ml-4">
                <SlantButton onMouseEnter={() => handleHover('lease')} onMouseLeave={() => handleHover('')} onClick={() => {}} text="Lease My Estate" className="bg-gray-500 hover:bg-pink-80h hover:border-gray-70" />
              </div>
            </div>
            <div className="mt-8">
