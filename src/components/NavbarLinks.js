            ...
            <div data-hover="" data-delay="0" className="nav-link w-dropdown ml-0 mr-0 align-top my-auto">
              ...
              {showDocs &&
                <nav id="docs-dropdown" className="flex flex-col block select-none lg:absolute pl-2 lg:pl-0 mt-0 lg:mt-2 bg-gray-500 border-r-0 border-b-0 lg:rounded-md lg:ring-1 lg:ring-gray-60">
                  ...
                  <a href={WhitepaperPDF} target="_blank" rel="noreferrer" className="w-dropdown-link text-10 xs:text-15 text-white hover:bg-white rounded-md hover:text-gray-500 pl-2 md:px-0 py-2 lg:py-2 lg:px-4">{'WHITEPAPER'}</a>
