            ...
            <div data-hover="" data-delay="0" className="nav-link w-dropdown ml-0 mr-0 align-top my-auto">
              ...
              {showDocs &&
                <nav id="docs-dropdown" className="flex flex-col block select-none lg:absolute pl-2 pr-3 ml-2 mt-0 lg:mt-2 bg-gray-500 border-r-0 border-b-0 lg:border-r-2 lg:border-b-2 border-gray-70">
                  ...
                  <a href={WhitepaperPDF} target="_blank" className="w-dropdown-link text-10 xs:text-15 text-white hover:text-white px-0 py-2 lg:pb-2 lg:px-2">{'Whitepaper'}</a>
                  <a href="https://wiki.mad.xyz" target="_blank" rel="noreferrer" className="w-dropdown-link text-10 xs:text-15 text-white  hover:text-white px-0 py-2 lg:pb-2 lg:px-2">{'GitBook'}</a>
                </nav>
              }
            </div>
          </div>
