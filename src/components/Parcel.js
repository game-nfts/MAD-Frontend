...
const Parcel = (props) => {
  ...
  return (
    <>
      <img
        className="h-auto w-full m-auto min-h-1/2 min-w-full"
        src={parcel.image}
        alt=""
      />
      <div className="h-1/2 w-full px-4 py-2">
        <div className="w-full h-full flex flex-col">
          <div className="w-full flex flex-row">
            <div className="text-gray-text-light text-sm">
              {parcel.name ? parcel.name : "Parcel"}
            </div>
                ...
                <>
                  <div>
                    <Button
                      ...
                      text="Cancel"
                      light={true}
                      className="bg-gray-525 hover:bg-black text-white w-full"
                    />
                  </div>
                  <div className="ml-auto">
                    <Button
                      ...
                      className={`${
                        true
                          ? ""
                          : "bg-gray-525 hover:bg-green-50 text-green-50 hover:text-gray-500"
                      } w-full`}
                    />
                  </div>
                </>
                ...
                <>
                  <div className="ml-auto">
                    <Button
                      ...
                      light={true}
                      color="pink"
                      className="bg-gray-500 hover:bg-pink-80 text-pink-80 hover:text-gray-500 w-full"
                    />
                  </div>
                </>
              )}
