...
import MediumHoverIcon from '../assets/medium_hover.svg';
          ...
          <div className={`max-w-7xl mx-auto px-2 sm:px-6 lg:px-8`}>
            <div className="relative flex items-center justify-center h-16">
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-center">
                ...
                <HoverImageButton className="h-10 mx-4 cursor-pointer" onDragStart={(e) => e.preventDefault()} onClick={() => {window.open('https://medium.com/metaverse-advertisement-dao', '_blank');}} defaultSrc={MediumIcon} hoverSrc={MediumHoverIcon} />
              </div>
            </div>
          </div>
        </div>
